...
describe CampaignMailerHelper do
  ...
  describe '#message' do
    it 'should return a partial found in the messages folder' do
  ...
  describe '#table' do
    it 'should return a partial found in the tables folder' do
  ...
  describe '#footer' do
    it 'should return a partial found in the footers folder' do
